...
// // Existe un método para eliminar el primer elemento de un array
// razas_gatos.shift();
// console.log("Shift, eliminar el primer elemento", razas_gatos)


// // El método 'splice' nos permite elegir que elemento del array queremos eliminar
var fruits = ["Banana", "Orange", "Apple", "Mango"];
fruits.splice(3, 1);        // Removes the second element of fruits
